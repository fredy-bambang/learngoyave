...
var TaskWhere = struct {
	...
	IsFinished: whereHelpernull_Bool{field: "\"task\".\"is_finished\""},
...
var (
	taskAllColumns            = []string{"id", "title", "is_finished", "created_at", "updated_at"}
	taskColumnsWithoutDefault = []string{"id", "title", "is_finished", "created_at", "updated_at"}
