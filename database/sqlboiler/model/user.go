...
var UserWhere = struct {
	...
	CreatedAt: whereHelpernull_String{field: "\"user\".\"created_at\""},
	UpdatedAt: whereHelpernull_String{field: "\"user\".\"updated_at\""},
}
...
var (
	...
	userColumnsWithoutDefault = []string{"id", "email", "password", "role", "created_at", "updated_at"}
