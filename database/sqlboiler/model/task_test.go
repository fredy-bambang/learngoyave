...
var (
	taskDBTypes = map[string]string{`ID`: `UUID`, `Title`: `CHARACTER VARYING(255)`, `IsFinished`: `BOOLEAN`, `CreatedAt`: `TIMESTAMP WITH TIME ZONE`, `UpdatedAt`: `TIMESTAMP WITH TIME ZONE`}
	_           = bytes.MinRead
)
