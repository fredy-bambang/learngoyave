...
var (
	userDBTypes = map[string]string{`ID`: `UUID`, `Email`: `CHARACTER VARYING(255)`, `Password`: `CHARACTER VARYING(255)`, `Role`: `CHARACTER VARYING(255)`, `CreatedAt`: `TIMESTAMP WITH TIME ZONE`, `UpdatedAt`: `TIMESTAMP WITH TIME ZONE`}
	_           = bytes.MinRead
)
